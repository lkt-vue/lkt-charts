...
export declare const createSankeyChart: (series: DataSet[], axisX?: AxisX | undefined, axisY?: AxisY | undefined) => Chart;
export declare const addBasicTooltip: (chart: Chart, trigger?: TooltipTriggers, triggerOn?: TooltipTriggerOn) => Chart;
export declare const setChartTitle: (chart: Chart, title?: string | undefined, subtitle?: string | undefined) => Chart;
